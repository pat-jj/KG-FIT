...
class KGFIT_ConvE(torch.nn.Module):
    def __init__(self, d, d1, d2, nentity, nrelation,
        ...
        self.emb_e = torch.nn.Embedding(nentity, d1, padding_idx=0)
        self.emb_rel = torch.nn.Embedding(nrelation, d2, padding_idx=0)
        ...
        self.register_parameter('b', Parameter(torch.zeros(nentity)))
    ...
    def init(self):
        ...
        self.emb_e.weight.data = self.rho * self.emb_e.weight.data + (1 - self.rho) * self.entity_text_embeddings
